...
semmap_dir = 'data/GT/semmap/'
data_dir = 'data/smnet_training_data'

sample_semmap_output_dir = 'data/smnet_training_data_semmap'
sample_indices_output_dir = 'data/smnet_training_data_indices'

semmap_info = json.load(open('data/GT/semmap_GT_info.json', 'r'))
...
json.dump(info, open('data/info_training_data_projections.json', 'w'))
